      ...
      <div className="container">
        <div className="user">
          ...
          {menuOpen && post.userId === currentUser.id && (
            <>
              <button className="deleteComment" onClick={handleUpdate}>
        ...
        {commentOpen && <Comments postId={post.id} key={post.id} postUserId={post.userId} currentUserId={currentUser.id}/>}
      </div>
    </div>
  );
};
